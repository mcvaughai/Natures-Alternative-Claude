        ...
        <div className="w-full max-w-md">
            ...
            <form className="space-y-4" onSubmit={handleLogin}>
              ...
              <div>
                ...
                <div className="flex justify-end mt-1.5">
                  <Link href="/forgot-password" className="text-xs text-[#1a4a2e] hover:underline font-medium">
                    Forgot Password?
                  </Link>
                </div>
              </div>
          ...
          <div className="text-center mt-5 space-y-2">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/signup" className="text-[#1a4a2e] font-semibold hover:underline">
                Sign Up
              </Link>
            </p>
            <p className="text-sm text-gray-600">
              Are you a seller?{" "}
              <Link href="/seller/login" className="text-[#1a4a2e] font-semibold hover:underline">
                Go to Seller Center
              </Link>
            </p>
          </div>
