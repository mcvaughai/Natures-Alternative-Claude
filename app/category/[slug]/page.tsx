...
function getCategoryName(slug: string): string {
  const names: Record<string, string> = {
    ...
    "herbs-plants": "Herbs & Plants",
    "honey-preserves": "Honey & Preserves",
    "nuts-grains": "Nuts & Grains",
  };
  return (
    names[slug] ||
    slug
...
const FARMS = [
  ...
  { id: "3", name: "W&W Farms",        tagline: "Family owned farm offering seasonal vegetables and free range eggs." },
  { id: "4", name: "Green Acres",      tagline: "Certified natural produce farm serving the greater Houston area." },
];

const CATEGORIES = [
  { label: "Fruits & Vegetables", count: 16 },
        ...
        <div className="bg-white border-b border-gray-200 py-4">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <select className="border border-gray-200 rounded-lg px-3 py-1.5 text-sm text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-[#1a4a2e]/20">
                    ...
                    {CATEGORIES.map((cat) => (
                      <label key={cat.label} className="flex items-center justify-between cursor-pointer group">
                        <div className="flex items-center gap-2.5">
                          <input
                            type="checkbox"
                            defaultChecked={cat.label === categoryName}
                            className="w-4 h-4 rounded border-gray-300 accent-[#1a4a2e]"
                          />
