  ...
  async function fetchData() {
    ...
    try {
      ...
      const productsResponse = await fetch(
        `${SUPABASE_URL}/rest/v1/products?category_id=eq.${category.id}&status=eq.active&select=id,name,price,unit,images,pricing_type,price_per_pound,stock_quantity,low_stock_threshold,sellers(farm_name,store_name,slug,fulfillment)`,
        { headers: HEADERS }
      );
