...
const CATEGORY_SLUG = 'bakery-breads'
const CATEGORY_NAME = 'Bakery & Breads'
const CATEGORY_DESC = 'Artisan breads, pastries, and baked goods made with whole grains and real ingredients'
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="none">
          <path d="M12 2L10 8H4l5 3.5L7 18l5-3.5L17 18l-2-6.5L20 8h-6z" fill="#1a4a2e"/>
          <path d="M9 21h6" stroke="#1a4a2e" strokeWidth="2" strokeLinecap="round"/>
          <path d="M12 18v3" stroke="#1a4a2e" strokeWidth="2" strokeLinecap="round"/>
        </svg>
          </div>
          <h1
