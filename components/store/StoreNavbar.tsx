...
export default function StoreNavbar({ storeId, activePage }: StoreNavbarProps) {
  ...
  return (
    <nav
      ...
      style={{ zIndex: 40, boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)', minHeight: '72px' }}
    >
      <div className="w-full px-8 flex items-center gap-4" style={{ minHeight: '72px' }}>
        ...
        {/* Nav links */}
        <div className="hidden md:flex items-center gap-10 text-base font-medium text-gray-600 ml-auto">
