...
const CATEGORY_TABS = ["All Products", "Meat & Seafood", "Fruits & Vegetables"];
    ...
    <header className="sticky top-0 z-50">
      ...
      <div className="bg-[#1a4a2e]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center gap-3">
          ...
          {/* Logo */}
          <a href="/" className="flex items-center gap-2 text-white font-bold shrink-0">
          ...
          <nav className="hidden lg:flex items-center gap-5 text-white text-sm whitespace-nowrap">
            ...
            <a href="#" className="hover:text-green-200 transition-colors">Our Store</a>
